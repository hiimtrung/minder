...
- [Data Model & MCP Tools](roadmap/03-data-model-and-tools.md) — 26 registered tools, data stores, session patterns, configuration

## Guides

- [Local Setup](guides/local-setup.md) — native install, backend, dashboard, setup wizard
- [Development](guides/development.md) — make targets, release workflow
- [Production Deployment](guides/production-deployment.md) — reverse proxy, bootstrap, headless server
- [Admin & Client Onboarding](guides/admin-client-onboarding.md) — admin creation, client setup, MCP config, session continuity
