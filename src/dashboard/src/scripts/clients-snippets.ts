...
export const ideInstructions: Array<{
...
}> = [
  {
    ...
    content: [
      ...
      "",
      "### Session continuity",
      "Boot or recover a session at the start of each significant task; save state before /compact:",
      "- `minder_session_boot` — create or recover a named session (single entry point)",
      "- `minder_session_save` — checkpoint work state; pass branch and open_files to update context",
  ...
  },
  {
    ...
    content: [
      ...
      "### Session continuity",
      "- minder_session_boot — create or recover a named session (single entry point)",
      "- minder_session_save — checkpoint work; pass branch/open_files to update context",
      "- minder_session_summarize — generate summary before /compact or long interruptions",
      "",
      "### Memory",
  ...
  },
  {
    ...
    content: [
      ...
      "",
      "Session continuity:",
      "- minder_session_boot — create or recover a named session",
      "- minder_session_save — checkpoint work; pass branch/open_files to update context",
      "",
      "Memory:",
