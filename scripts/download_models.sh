...
EMBED_URL="${MINDER_EMBED_MODEL_URL:-https://huggingface.co/Qwen/Qwen3-Embedding-0.6B-GGUF/resolve/main/qwen3-embedding-0.6b.Q8_0.gguf}"
LLM_URL="${MINDER_LLM_MODEL_URL:-https://huggingface.co/Qwen/Qwen3.5-0.8B-GGUF/resolve/main/qwen3.5-0.8b-instruct.Q4_K_M.gguf}"
