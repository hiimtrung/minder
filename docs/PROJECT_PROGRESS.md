...
| `P1-T21` GitHub Actions Release              | `3`     | `DONE` | `-`    | `release.yml now publishes API/dashboard images and attaches a one-shot installer plus release quick-start notes` |
...
| `P4-T06` Production Docker Compose                         | `P4-Wave5` | `DONE`        | `-`                                                                | Added image-only `docker/docker-compose.yml`, source-build `docker/docker-compose.full.yml`, GHCR release defaults, and a GitHub-release installer script that fetches the tagged runtime bundle and starts the full stack.                                                                                                      |
...
| `P4.3-POST` Dashboard Routing Polish          | `post-P4.3`  | `DONE` | `-`     | Completed route polish for dedicated client detail routing, CORS fallback for Astro dev, dashboard/root favicon handling, and compatibility serving for Astro bundle layouts.                                                                                  |
